    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        <div className="bg-gradient-to-r from-blue-900 to-blue-700 px-6 py-8 text-white text-center">
          ...
          <p className="mt-2 text-blue-100">Matbaa Rehberi'ne firmanızı ekleyin</p>
        </div>
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit}>
            {/* Firma Adı */}
            <div className="mb-4">
              <label htmlFor="companyName" className="block text-gray-700 font-medium mb-2">Firma Adı</label>
              <input
                type="text"
                id="companyName"
                name="companyName"
            ...
            {/* Şifre Tekrarı */}
            <div className="mb-6">
              <label htmlFor="confirmPassword" className="block text-gray-700 font-medium mb-2">Şifre Tekrarı</label>
              <input
                type="password"
                id="confirmPassword"
