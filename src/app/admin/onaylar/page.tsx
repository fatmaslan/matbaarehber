          ...
          <div className="p-6">
            ...
            {pendingApprovals.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-gray-500 mb-2">Bekleyen onay isteği bulunmamaktadır.</p>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="bg-gradient-to-r from-blue-900 to-blue-700 px-6 py-4 text-white flex justify-between items-center">
              <h2 className="text-xl font-bold">
                {selectedApproval.type === 'registration' ? 'Yeni Firma Kaydı' : 'Profil Güncelleme'}
              </h2>
            ...
            <div className="p-6">
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Firma Bilgileri</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {new Date(selectedApproval.submitted_at).toLocaleString('tr-TR')}
                      </p>
                    </div>
                    ...
                    {selectedApproval.data?.email && (
                      <div>
                        ...
                        <p className="font-medium">{selectedApproval.data.email}</p>
                      </div>
                    )}
              ...
              {selectedApproval.data?.description && (
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">Değişiklikler</h3>
                  <div className="bg-gray-50 p-4 rounded-md">
                    <p className="text-sm text-gray-500">Açıklama</p>
                    <p className="whitespace-pre-wrap">{selectedApproval.data.description}</p>
                  </div>
                </div>
              )}

              {selectedApproval.type === 'registration' && selectedApproval.companyId && (
                <div className="mb-6">
                  <Link
