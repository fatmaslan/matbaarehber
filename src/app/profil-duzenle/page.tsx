...
const ProfileEditPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (fetchedRef.current) return; // ikinci çalışmayı engelle
                            ...
                            <div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex items-center">
                                        <div
                                            className="w-20 h-20 bg-gray-100 rounded-md overflow-hidden flex items-center justify-center mr-4">
                                        ...
                                        <label
                                            className="cursor-pointer bg-blue-50 text-blue-600 px-4 py-2 rounded-md hover:bg-blue-100 transition-colors flex items-center">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="mb-4">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                                    ...
                                    <label
                                        className="h-24 border-2 border-dashed border-gray-300 rounded-md flex items-center justify-center cursor-pointer hover:bg-gray-50 transition-colors">
